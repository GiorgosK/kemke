...
/**
 * Provides chunked file upload endpoints for the Case API.
 */
final class FileUploadController extends ControllerBase {
  ...
  public function init(Request $request): JsonResponse {
    ...
    try {
      ...
      $this->getLogger('case_api')->error('Failed to initialise chunked upload: @message', ['@message' => $exception->getMessage()]);
  ...
  public function uploadChunk(Request $request): JsonResponse {
    ...
    try {
      ...
      $this->getLogger('case_api')->error('Failed to append upload chunk: @message', ['@message' => $exception->getMessage()]);
  ...
  public function complete(Request $request): JsonResponse {
    ...
    try {
      ...
      $this->getLogger('case_api')->error('Failed to finalise upload session: @message', ['@message' => $exception->getMessage()]);
  ...
  public function cancel(Request $request): JsonResponse {
    ...
    try {
      ...
      $this->getLogger('case_api')->error('Failed to cancel upload session: @message', ['@message' => $exception->getMessage()]);
  ...
  private function extractPayload(Request $request): ?array {
    ...
    try {
      ...
      $this->getLogger('case_api')->warning('Chunk upload JSON decoding failed: @message', ['@message' => $exception->getMessage()]);
      return NULL;
    }
